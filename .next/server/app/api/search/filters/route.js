(()=>{var E={};E.id=3102,E.ids=[3102],E.modules={3295:E=>{"use strict";E.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},3743:(E,e,T)=>{"use strict";T.a(E,async(E,s)=>{try{T.r(e),T.d(e,{patchFetch:()=>o,routeModule:()=>d,serverHooks:()=>A,workAsyncStorage:()=>n,workUnitAsyncStorage:()=>L});var t=T(96559),i=T(48088),a=T(37719),r=T(50467),N=E([r]);r=(N.then?(await N)():N)[0];let d=new t.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/search/filters/route",pathname:"/api/search/filters",filename:"route",bundlePath:"app/api/search/filters/route"},resolvedPagePath:"/Users/krithikalluri/Documents/GitHub/PeerPenWebsite/app/api/search/filters/route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:n,workUnitAsyncStorage:L,serverHooks:A}=d;function o(){return(0,a.patchFetch)({workAsyncStorage:n,workUnitAsyncStorage:L})}s()}catch(E){s(E)}})},7462:(E,e,T)=>{"use strict";T.a(E,async(E,s)=>{try{T.r(e),T.d(e,{checkDatabase:()=>N,default:()=>d,initDatabase:()=>a});var t=T(28855),i=E([t]);t=(i.then?(await i)():i)[0];let o=(0,t.createClient)({url:process.env.TURSO_DATABASE_URL,authToken:process.env.TURSO_AUTH_TOKEN});async function a(){try{for(let E of(console.log("Initializing database with full schema..."),["PRAGMA foreign_keys = ON;",`CREATE TABLE IF NOT EXISTS profiles (
        id                 TEXT PRIMARY KEY,
      ...
      WHERE college IS NOT NULL 
        ...
        AND is_deleted = 0
      ORDER BY college
    `,e=(await i.default.execute({sql:E,args:[]})).rows.map(E=>E.college),T=`
      ...
      ORDER BY prompt
      LIMIT 50
    `,s=(await i.default.execute({sql:T,args:[]})).rows.map(E=>E.tag);return t.NextResponse.json({colleges:e,tags:s})}catch(E){return console.error("Filters error:",E),t.NextResponse.json({error:"Failed to fetch filters"},{status:500})}}i=(a.then?(await a)():a)[0],s()}catch(E){s(E)}})},63033:E=>{"use strict";E.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},78335:()=>{},96487:()=>{},96559:(E,e,T)=>{"use strict";E.exports=T(44870)}};var e=require("../../../../webpack-runtime.js");e.C(E);var T=E=>e(e.s=E),s=e.X(0,[80],()=>T(3743));module.exports=s})();