(()=>{var E={};E.id=3846,E.ids=[3846],E.modules={3295:E=>{"use strict";E.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},7462:(E,e,T)=>{"use strict";T.a(E,async(E,t)=>{try{T.r(e),T.d(e,{checkDatabase:()=>N,default:()=>n,initDatabase:()=>a});var s=T(28855),i=E([s]);s=(i.then?(await i)():i)[0];let o=(0,s.createClient)({url:process.env.TURSO_DATABASE_URL,authToken:process.env.TURSO_AUTH_TOKEN});async function a(){try{for(let E of(console.log("Initializing database with full schema..."),["PRAGMA foreign_keys = ON;",`CREATE TABLE IF NOT EXISTS profiles (
        id                 TEXT PRIMARY KEY,
      ...
      GROUP BY fb.essay_id;`]))try{await o.execute(E)}catch(E){if(E instanceof Error&&E.message.includes("already exists")){console.log("Table/view already exists, skipping...");continue}throw E}console.log("Database initialized successfully with full schema!"),await r()}catch(E){throw console.error("Error initializing database:",E),E}}async function r(){try{try{await o.execute("ALTER TABLE profiles ADD COLUMN email TEXT"),console.log("Migration: Added email column to profiles table")}catch(E){E.message?.includes("duplicate column name")||console.error("Migration error:",E)}}catch(E){console.error("Error running migrations:",E)}}async function N(){try{return(await o.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='essays'")).rows.length>0}catch(E){return console.error("Error checking database:",E),!1}}let n=o;t()}catch(E){t(E)}})},10846:E=>{"use strict";E.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},28855:E=>{"use strict";E.exports=import("@libsql/client")},29294:E=>{"use strict";E.exports=require("next/dist/server/app-render/work-async-storage.external.js")},33907:(E,e,T)=>{"use strict";T.a(E,async(E,t)=>{try{T.r(e),T.d(e,{POST:()=>r});var s=T(32190),i=T(7462),a=E([i]);async function r(){try{await (0,i.checkDatabase)()||(console.log("Database not initialized, initializing now..."),await (0,i.initDatabase)()),await i.default.execute({sql:"DELETE FROM essay_fts",args:[]});let E=await i.default.execute({sql:`
        SELECT id, title, content 
        FROM essays 
        WHERE is_deleted = 0
      `,args:[]}),e=0;for(let T of E.rows)try{await i.default.execute({sql:`
            INSERT INTO essay_fts (rowid, title, content, essay_id)
            VALUES (?, ?, ?, ?)
          `,args:[T.id,T.title,T.content,T.id]}),e++}catch(E){console.error(`Failed to insert essay ${T.id} into FTS:`,E)}return s.NextResponse.json({success:!0,message:`Successfully populated FTS table with ${e} essays`,insertedCount:e})}catch(E){return console.error("Failed to populate FTS table:",E),s.NextResponse.json({error:"Failed to populate FTS table",details:E instanceof Error?E.message:"Unknown error"},{status:500})}}i=(a.then?(await a)():a)[0],t()}catch(E){t(E)}})},44870:E=>{"use strict";E.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:E=>{"use strict";E.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},73623:(E,e,T)=>{"use strict";T.a(E,async(E,t)=>{try{T.r(e),T.d(e,{patchFetch:()=>o,routeModule:()=>n,serverHooks:()=>A,workAsyncStorage:()=>d,workUnitAsyncStorage:()=>L});var s=T(96559),i=T(48088),a=T(37719),r=T(33907),N=E([r]);r=(N.then?(await N)():N)[0];let n=new s.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/init-db/populate-fts/route",pathname:"/api/init-db/populate-fts",filename:"route",bundlePath:"app/api/init-db/populate-fts/route"},resolvedPagePath:"/Users/krithikalluri/Documents/GitHub/PeerPenWebsite/app/api/init-db/populate-fts/route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:d,workUnitAsyncStorage:L,serverHooks:A}=n;function o(){return(0,a.patchFetch)({workAsyncStorage:d,workUnitAsyncStorage:L})}t()}catch(E){t(E)}})},78335:()=>{},96487:()=>{},96559:(E,e,T)=>{"use strict";E.exports=T(44870)}};var e=require("../../../../webpack-runtime.js");e.C(E);var T=E=>e(e.s=E),t=e.X(0,[80],()=>T(73623));module.exports=t})();